                      ...
                      <div class="md:w-full mx-auto">
                        <div>
                          ...
                          <div class="flex gap-16 justify-center">
                            ...
                            <!-- 削除 -->
                            <form id="delete_{{ $contact->id }}" method="get" action="{{ route('contacts.edit', ['id' => $contact->id]) }}">
                              @csrf
                              <div class="p-2 w-full">
                                <a href="#" data-id="{{ $contact->id }}" onClick="deletePost(this)" class="flex mx-auto text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-700 rounded text-lg">
                                  削除する
                                </a>
                              </div>
                            </form>
