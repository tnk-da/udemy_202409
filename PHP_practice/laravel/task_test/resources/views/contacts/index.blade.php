                    ...
                    <table class="table-auto w-full text-left whitespace-no-wrap">
                      <thead>
                        <tr>
                          ...
                          <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">見出し</th>
                        </tr>
                      </thead>
                      <tbody>
                      @foreach($contacts as $contact)
                        <tr>
                          ...
                          <td class="border-t-2 border-gray-200 px-4 py-3 text-red-300"><a href="{{ route('contacts.show', ['id' => $contact->id]) }}">詳細を見る</a></td>
                        </tr>
                      @endforeach
                      </tbody>
                    </table>
